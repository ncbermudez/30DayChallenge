##30DayChartChallenge | May 2023 - Day 26 | Networks
...
# Data goes from October 1950s to October 1980s. 
# DISCLAMER: This code is so long and should be replaced with some sort of a loop later

## 1950s
# October 1950 – April 1951
get_data_1 <- web_data %>%
  html_nodes(xpath = '//*[@id="mw-content-text"]/div[1]/div[2]/table/tbody/tr/td[1]') %>%
...
df_network %>% 
  ...
  scale_color_manual(values = c("#672fe6", "#f6ac0f", "#85bb65", "#f60f5a", "black"), guide = "none") +
  ...
  annotate("curve", x = 2.6, y = -9.25, xend = 6, yend = -12.5, linewidth = 0.7,  curvature = -0.15, arrow = arrow(length = unit(1, "mm")), color = "#85bb65") +
  annotate("text", x = 6.5, y = -13.5, label = "The Simpsons", color = "#85bb65", family = font, fontface = "bold", size = 4) +
  theme_void() +
  theme(plot.title = element_text(family = font_t, size = 22, hjust = 0, face = "bold", color = "#000000"),
        ...
        plot.caption = element_text(size = 10, family = font, color = "#000000", hjust = 0.5),
        legend.position = "top",
        legend.margin = margin(t = 10),
        legend.text = element_text(size = 7, family = font, color = "#272324", hjust = 0.5),
        legend.title = element_text(size = 7, family = font, color = "#272324", hjust = 0.5),
        plot.margin = unit(c(0.5, 0.5, 0.5, 0.5), "cm"),
        plot.background = element_rect(color = NA, fill = "#FFFFFF")) +
  labs(title = "TELEVISION NETWORKS",
       subtitle = "Three networks — <span style='color: #672fe6;'><b>ABC</b></span>, <span style='color: #f6ac0f;'><b>CBS</b></span>, and <span style='color: #f60f5a;'><b>NBC</b></span> — dominated American primetime network television for decades until <br><span style='color: #85bb65;'>\n<b>FOX</b></span> landed in the top 30 rated shows with a little show called The Simpsons in 1989.",
       caption = "\n\n\n#30DayChartChallenge - Day 26 | Data: wikipedia | Design: Ryan Hart | Adapted: Neili Bermúdez")

# Set workind directory and save plot
setwd("C:/Users/ncber/OneDrive/Documentos/Practice in R/30daysChallenge/Day_26")
ggsave(paste0("day_26_", format(Sys.time(), "%d%m%Y"), ".png"), dpi = 320, width = 10, height = 8, units = "in")
